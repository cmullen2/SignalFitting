...
//  RF->LoadVariable("MissMass[1850,2850]");//should be same name as variable in tree 
  RF->LoadVariable("ConeAngle[0,0.7]");//should be same name as variable in tree 
  RooRealVar * var=RF->GetWorkSpace()->var("ConeAngle");
...
//  RF->ConfigureSavedBins("/w/work1/home/chris/LatestAnalysisRuns/Data/DataJul17/HaspectOutput/Fitting/All3Binned1FilesProtonW10/");
  ...
  RF->Factory("RooHSEventsHistPDF::Sig(ConeAngle,alpha[0,0,0.04],off[0,0,0.05],scale[1,0.8,1.2])");
  ...
  RF->Factory("RooHSEventsHistPDF::BG(ConeAngle,alphaB[0,0,0.04],offB[0,0,0],scaleB[1.0,0.8,1.2])");
...
//Multi Pion Bgs
  ...
  RF->Factory("RooHSEventsHistPDF::PEta(ConeAngle,alphaPEta[0,0,0.04],offPEta[0,0,0.05],scalePEta[1,0.8,1.2])"); //4
  RooHSEventsHistPDF* pdfPEta=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("PEta")); //2
  RF->LoadSpeciesPDF("PEta",1); //1


  RF->Factory("RooHSEventsHistPDF::NEta(ConeAngle,alphaNEta[0,0,0.04],offNEta[0,0,0.05],scaleNEta[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfNEta=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("NEta"));
  RF->LoadSpeciesPDF("NEta",1);


  RF->Factory("RooHSEventsHistPDF::NPi0Pi0(ConeAngle,alphaNPi0Pi0[0,0,0.04],offNPi0Pi0[0,0,0.05],scaleNPi0Pi0[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfNPi0Pi0=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("NPi0Pi0"));
  RF->LoadSpeciesPDF("NPi0Pi0",1);


  RF->Factory("RooHSEventsHistPDF::NPipPim(ConeAngle,alphaNPipPim[0,0,0.04],offNPipPim[0,0,0.05],scaleNPipPim[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfNPipPim=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("NPipPim"));
  RF->LoadSpeciesPDF("NPipPim",1);


  RF->Factory("RooHSEventsHistPDF::NPipPi0(ConeAngle,alphaNPipPi0[0,0,0.04],offNPipPi0[0,0,0.05],scaleNPipPi0[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfNPipPi0=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("NPipPi0"));
  RF->LoadSpeciesPDF("NPipPi0",1);


  RF->Factory("RooHSEventsHistPDF::PPi0Pi0(ConeAngle,alphaPPi0Pi0[0,0,0.04],offPPi0Pi0[0,0,0.05],scalePPi0Pi0[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfPPi0Pi0=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("PPi0Pi0"));
  RF->LoadSpeciesPDF("PPi0Pi0",1);


  RF->Factory("RooHSEventsHistPDF::PPipPim(ConeAngle,alphaPPipPim[0,0,0.04],offPPipPim[0,0,0.05],scalePPipPim[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfPPipPim=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("PPipPim"));
  RF->LoadSpeciesPDF("PPipPim",1);


  RF->Factory("RooHSEventsHistPDF::PPi0Pim(ConeAngle,alphaPPi0Pim[0,0,0.04],offPPi0Pim[0,0,0.05],scalePPi0Pim[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfPPi0Pim=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("PPi0Pim"));
  RF->LoadSpeciesPDF("PPi0Pim",1);


  RF->Factory("RooHSEventsHistPDF::PCompton(ConeAngle,alphaPCompton[0,0,0.04],offPCompton[0,0,0.05],scalePCompton[1,0.8,1.2])");
  RooHSEventsHistPDF* pdfPCompton=dynamic_cast<RooHSEventsHistPDF*>(RF->GetWorkSpace()->pdf("PCompton"));
  RF->LoadSpeciesPDF("PCompton",1);


  RF->Factory("RooHSEventsHistPDF::NCompton(ConeAngle,alphaNCompton[0,0,0.04],offNCompton[0,0,0.05],scaleNCompton[1,0.8,1.2])");
