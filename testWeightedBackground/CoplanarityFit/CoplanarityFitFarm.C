...
//  pdfPPi0Pi0->LoadWeights("PPi0Pi0T",weightsPathPPi0Pi0,"HSsWeights"); //WILL NEED TO BE CHANGED TO Sig AS THIS IS THE NEW NAME USED IN THE INV MASS FIT
  pdfPPi0Pi0->LoadWeights("Sig",weightsPathPPi0Pi0,"HSsWeights"); //WILL NEED TO BE CHANGED TO Sig AS THIS IS THE NEW NAME USED IN THE INV MASS FIT
  cout << " Past the PPi0Pi0Weights Loading "  <<endl; 

  TString weightsPathPPi0Pim = fileDir + "/InvMassPPi0Pim/Weights" + job + ".root";
//  pdfPPi0Pim->LoadWeights("PPi0PimT",weightsPathPPi0Pim,"HSsWeights"); 
  pdfPPi0Pim->LoadWeights("Sig",weightsPathPPi0Pim,"HSsWeights"); 
  cout << " Past the PPi0PimWeights Loading "  <<endl; 

  TString weightsPathPPipPim = fileDir + "/InvMassPPipPim/Weights" + job + ".root";
//  pdfPPipPim->LoadWeights("PPipPimT",weightsPathPPipPim,"HSsWeights"); 
  pdfPPipPim->LoadWeights("Sig",weightsPathPPipPim,"HSsWeights"); 
  cout << " Past the PPipPimWeights Loading "  <<endl; 

  TString weightsPathNPi0Pi0 = fileDir + "/InvMassNPi0Pi0/Weights" + job + ".root";
//  pdfNPi0Pi0->LoadWeights("NPi0Pi0T",weightsPathNPi0Pi0,"HSsWeights"); 
  pdfNPi0Pi0->LoadWeights("Sig",weightsPathNPi0Pi0,"HSsWeights"); 
  cout << " Past the NPi0Pi0Weights Loading "  <<endl; 

  TString weightsPathNPipPi0 = fileDir + "/InvMassNPipPi0/Weights" + job + ".root";
//  pdfNPipPi0->LoadWeights("NPipPi0T",weightsPathNPipPi0,"HSsWeights"); 
  pdfNPipPi0->LoadWeights("Sig",weightsPathNPipPi0,"HSsWeights"); 
  cout << " Past the NPipPi0Weights Loading "  <<endl; 
 
  TString weightsPathNPipPim = fileDir + "/InvMassNPipPim/Weights" + job + ".root";
//  pdfNPipPim->LoadWeights("NPipPimT",weightsPathNPipPim,"HSsWeights"); 
  pdfNPipPim->LoadWeights("Sig",weightsPathNPipPim,"HSsWeights"); 
...
//  pdfPCompton->LoadWeights("PCompton",weightsPathPCompton,"HSsWeights"); 
  pdfPCompton->LoadWeights("Sig",weightsPathPCompton,"HSsWeights"); 
...
//  pdfNCompton->LoadWeights("NCompton",weightsPathNCompton,"HSsWeights"); 
  pdfNCompton->LoadWeights("Sig",weightsPathNCompton,"HSsWeights"); 
...
//if(RF->GetWeights())  RF->GetWeights()->Save(); //Added Cam 4th Feb 2018, think this is now needed to be able to load weights later
